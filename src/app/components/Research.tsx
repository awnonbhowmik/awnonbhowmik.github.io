    ...
    <section id="research" className="py-16 bg-[#1a1a1a] text-white">
      ...
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-6 mt-8">
        {researchAreas.map((area, index) => (
          ...
          >
            <div className="mb-4 text-blue-400 transition-transform hover:scale-110">{area.icon}</div>
            <h3 className="text-3xl font-semibold text-blue-400 mb-2">{area.title}</h3>
